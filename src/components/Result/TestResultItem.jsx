...
const TestResultItem = ({ result }) => {
  ...
  const { mutate: updateMutate } = useCustomMutation(updateTestResultVisibility, queryKeys.resultController.results())
  const { mutate: deleteMutate } = useCustomMutation(deleteTestResult)
